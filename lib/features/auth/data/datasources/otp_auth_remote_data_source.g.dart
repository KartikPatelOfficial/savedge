...
class _OtpAuthRemoteDataSource implements OtpAuthRemoteDataSource {
  ...
  Future<IndividualRegistrationResponse> registerIndividual(
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<IndividualRegistrationResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late IndividualRegistrationResponse _value;
    try {
      _value = IndividualRegistrationResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
