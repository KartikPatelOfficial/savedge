...
part of 'city_remote_data_source.dart';
...
class _CityRemoteDataSource implements CityRemoteDataSource {
  _CityRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<List<CityModel>>> getCities() async {
    ...
    final _options = _setStreamType<HttpResponse<List<CityModel>>>(
