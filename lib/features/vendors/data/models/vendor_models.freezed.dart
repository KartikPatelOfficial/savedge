...
mixin _$VendorImageDto {
 ...
 int get id; String get imageUrl; String? get thumbnailUrl; String? get mediumUrl; String? get altText; int get displayOrder; bool get isPrimary; String? get blurHash;// Tolerate missing/unknown values (e.g. a stray 0 from list endpoints)
...
@useResult
$Res call({
 int id, String imageUrl, String? thumbnailUrl, String? mediumUrl, String? altText, int displayOrder, bool isPrimary, String? blurHash,@JsonKey(unknownEnumValue: ImageType.gallery) ImageType imageType, String imageTypeName
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String imageUrl,  String? thumbnailUrl,  String? mediumUrl,  String? altText,  int displayOrder,  bool isPrimary,  String? blurHash, @JsonKey(unknownEnumValue: ImageType.gallery)  ImageType imageType,  String imageTypeName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VendorImageDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String imageUrl,  String? thumbnailUrl,  String? mediumUrl,  String? altText,  int displayOrder,  bool isPrimary,  String? blurHash, @JsonKey(unknownEnumValue: ImageType.gallery)  ImageType imageType,  String imageTypeName)  $default,) {final _that = this;
switch (_that) {
case _VendorImageDto():
return $default(_that.id,_that.imageUrl,_that.thumbnailUrl,_that.mediumUrl,_that.altText,_that.displayOrder,_that.isPrimary,_that.blurHash,_that.imageType,_that.imageTypeName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String imageUrl,  String? thumbnailUrl,  String? mediumUrl,  String? altText,  int displayOrder,  bool isPrimary,  String? blurHash, @JsonKey(unknownEnumValue: ImageType.gallery)  ImageType imageType,  String imageTypeName)?  $default,) {final _that = this;
switch (_that) {
case _VendorImageDto() when $default != null:
return $default(_that.id,_that.imageUrl,_that.thumbnailUrl,_that.mediumUrl,_that.altText,_that.displayOrder,_that.isPrimary,_that.blurHash,_that.imageType,_that.imageTypeName);case _:
  return null;
...
class _VendorImageDto implements VendorImageDto {
  const _VendorImageDto({this.id = 0, required this.imageUrl, this.thumbnailUrl, this.mediumUrl, this.altText, this.displayOrder = 0, required this.isPrimary, this.blurHash, @JsonKey(unknownEnumValue: ImageType.gallery) this.imageType = ImageType.gallery, this.imageTypeName = 'Gallery'});
