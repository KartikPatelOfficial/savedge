...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VendorResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.businessName, businessName) || other.businessName == businessName)&&(identical(other.description, description) || other.description == description)&&(identical(other.contactEmail, contactEmail) || other.contactEmail == contactEmail)&&(identical(other.contactPhone, contactPhone) || other.contactPhone == contactPhone)&&(identical(other.address, address) || other.address == address)&&(identical(other.city, city) || other.city == city)&&(identical(other.state, state) || other.state == state)&&(identical(other.pinCode, pinCode) || other.pinCode == pinCode)&&(identical(other.category, category) || other.category == category)&&(identical(other.website, website) || other.website == website)&&(identical(other.approvalStatus, approvalStatus) || other.approvalStatus == approvalStatus)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.approvedAt, approvedAt) || other.approvedAt == approvedAt)&&(identical(other.approvedBy, approvedBy) || other.approvedBy == approvedBy)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.firebaseUid, firebaseUid) || other.firebaseUid == firebaseUid)&&(identical(other.vendorFirstName, vendorFirstName) || other.vendorFirstName == vendorFirstName)&&(identical(other.vendorLastName, vendorLastName) || other.vendorLastName == vendorLastName)&&(identical(other.vendorFullName, vendorFullName) || other.vendorFullName == vendorFullName)&&const DeepCollectionEquality().equals(other.images, images)&&const DeepCollectionEquality().equals(other.socialMediaLinks, socialMediaLinks));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,businessName,description,contactEmail,contactPhone,address,city,state,pinCode,category,website,approvalStatus,isActive,approvedAt,approvedBy,createdAt,firebaseUid,vendorFirstName,vendorLastName,vendorFullName,const DeepCollectionEquality().hash(images),const DeepCollectionEquality().hash(socialMediaLinks)]);

@override
String toString() {
  return 'VendorResponse(id: $id, businessName: $businessName, description: $description, contactEmail: $contactEmail, contactPhone: $contactPhone, address: $address, city: $city, state: $state, pinCode: $pinCode, category: $category, website: $website, approvalStatus: $approvalStatus, isActive: $isActive, approvedAt: $approvedAt, approvedBy: $approvedBy, createdAt: $createdAt, firebaseUid: $firebaseUid, vendorFirstName: $vendorFirstName, vendorLastName: $vendorLastName, vendorFullName: $vendorFullName, images: $images, socialMediaLinks: $socialMediaLinks)';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VendorResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.businessName, businessName) || other.businessName == businessName)&&(identical(other.description, description) || other.description == description)&&(identical(other.contactEmail, contactEmail) || other.contactEmail == contactEmail)&&(identical(other.contactPhone, contactPhone) || other.contactPhone == contactPhone)&&(identical(other.address, address) || other.address == address)&&(identical(other.city, city) || other.city == city)&&(identical(other.state, state) || other.state == state)&&(identical(other.pinCode, pinCode) || other.pinCode == pinCode)&&(identical(other.category, category) || other.category == category)&&(identical(other.website, website) || other.website == website)&&(identical(other.approvalStatus, approvalStatus) || other.approvalStatus == approvalStatus)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.approvedAt, approvedAt) || other.approvedAt == approvedAt)&&(identical(other.approvedBy, approvedBy) || other.approvedBy == approvedBy)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.firebaseUid, firebaseUid) || other.firebaseUid == firebaseUid)&&(identical(other.vendorFirstName, vendorFirstName) || other.vendorFirstName == vendorFirstName)&&(identical(other.vendorLastName, vendorLastName) || other.vendorLastName == vendorLastName)&&(identical(other.vendorFullName, vendorFullName) || other.vendorFullName == vendorFullName)&&const DeepCollectionEquality().equals(other._images, _images)&&const DeepCollectionEquality().equals(other._socialMediaLinks, _socialMediaLinks));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,businessName,description,contactEmail,contactPhone,address,city,state,pinCode,category,website,approvalStatus,isActive,approvedAt,approvedBy,createdAt,firebaseUid,vendorFirstName,vendorLastName,vendorFullName,const DeepCollectionEquality().hash(_images),const DeepCollectionEquality().hash(_socialMediaLinks)]);
