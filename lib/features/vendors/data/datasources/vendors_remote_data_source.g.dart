...
class _VendorsRemoteDataSource implements VendorsRemoteDataSource {
  ...
  @override
  Future<HttpResponse<VendorResponse>> getVendor(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<VendorResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/Vendors/${id}',
    ...
    late VendorResponse _value;
    try {
      _value = VendorResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<List<VendorImageDto>>> getVendorImages(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<VendorImageDto>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    late List<VendorImageDto> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => VendorImageDto.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
