  ...
  Widget build(BuildContext context) {
    ...
    if (plans.length == 1) {
      return Padding(
        ...
        child: _SubscriptionPlanCard(plan: plans.first, onTap: onPlanTap),
      );
    }

    // Multiple plans: show as horizontal carousel
    return SizedBox(
      height: height, // Height from parameter
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Padding(
            ...
            child: _SubscriptionPlanCard(plan: plans[index], onTap: onPlanTap),
          );
        },
      ),
    );
