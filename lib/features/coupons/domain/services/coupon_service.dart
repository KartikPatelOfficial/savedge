...
import '../../data/models/coupon_claim_models.dart';
...
class CouponService {
  ...
  Future<CouponCheckResponse> checkCoupon(int couponId) async {
    try {
      ...
      return CouponCheckResponse.fromJson(response.data as Map<String, dynamic>);
    } catch (e) {
  ...
  Future<CouponClaimResponse> claimCoupon(int couponId) async {
    try {
      ...
      return CouponClaimResponse.fromJson(response.data as Map<String, dynamic>);
    } catch (e) {
  ...
  Future<CouponClaimResponse> claimCouponWithPoints(int couponId, int pointsCost) async {
    try {
      final requestData = {
        'couponId': couponId,
  ...
  Future<CouponClaimResponse> purchaseCoupon(int couponId, double amount) async {
    try {
      final requestData = {
        'couponId': couponId,
        'amount': amount,
