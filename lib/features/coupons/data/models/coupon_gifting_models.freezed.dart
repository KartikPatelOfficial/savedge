...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,couponId,title,description,vendorId,vendorUserId,vendorName,vendorCategory,status,acquiredDate,redeemedDate,expiryDate,uniqueCode,qrCode,discountType,discountValue,minCartValue,source,amountPaid,imageUrl,isGifted,giftedFromUserId,giftedToUserId,giftedDate,giftMessage]);
...
class _UserCouponDetailModel implements UserCouponDetailModel {
  const _UserCouponDetailModel({required this.id, required this.couponId, required this.title, this.description, @JsonKey(name: 'vendorProfileId') required this.vendorId, required this.vendorUserId, required this.vendorName, this.vendorCategory = '', required this.status, @JsonKey(name: 'purchasedDate') required this.acquiredDate, this.redeemedDate, @JsonKey(name: 'validUntil') required this.expiryDate, required this.uniqueCode, this.qrCode, required this.discountType, required this.discountValue, this.minCartValue, this.source, this.amountPaid, this.imageUrl, required this.isGifted, this.giftedFromUserId, this.giftedToUserId, this.giftedDate, this.giftMessage});
