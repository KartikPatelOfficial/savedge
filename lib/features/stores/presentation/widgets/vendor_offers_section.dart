...
class _VendorOfferCardState extends State<VendorOfferCard>
  ...
  void _onCouponTap(BuildContext context) {
    HapticFeedback.lightImpact();
    _showPointsPaymentDialog(context);
  }

  void _showPointsPaymentDialog(BuildContext context) {
    final primaryColor = _getPrimaryColor();
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          widget.coupon.cashPrice != null &&
                                  widget.coupon.cashPrice! > 0
                              ? '${(widget.coupon.cashPrice! * 10).toInt()} pts'
                              : 'FREE',
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.w700,
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Material(
                        color: Colors.transparent,
                        child: InkWell(
                          onTap: () => _processPointsPayment(context),
                          borderRadius: BorderRadius.circular(12),
                          child: const Center(
                            child: Text(
                              'Redeem Now',
  ...
  void _processPointsPayment(BuildContext context) {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Enjoy your ${widget.coupon.title}',
                      style: TextStyle(
                        color: Colors.white.withOpacity(0.9),
                        fontSize: 13,
                      ),
