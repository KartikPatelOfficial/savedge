    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildReadOnlyField('First Name', widget.userProfile.firstName ?? 'Not set'),
          const SizedBox(height: 12),
          _buildReadOnlyField('Last Name', widget.userProfile.lastName ?? 'Not set'),
          const SizedBox(height: 12),
          _buildReadOnlyField('Email', widget.userProfile.email),
          if (widget.userProfile.organizationName != null) ...[
            const SizedBox(height: 12),
            _buildReadOnlyField('Organization', widget.userProfile.organizationName!),
          ],
          if (widget.userProfile.employeeCode != null) ...[
            const SizedBox(height: 12),
            _buildReadOnlyField('Employee ID', widget.userProfile.employeeCode!),
          ],
